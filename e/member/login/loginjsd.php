...
{
?>
document.write(" <a href=\"/e/member/cp/\">  <i class=\"fa fa-user\"></i> 您好：<?=$myusername?> [ <?=$groupname?> ] </a> &nbsp; <a href=\"/e/DoInfo/ChangeClass.php?mid=1\">  <i class=\"fa fa-file-text\"></i> 发表文章 </a> &nbsp; <a href=\"/e/member/doaction.php?enews=exit&ecmsfrom=9\" onclick=\"return confirm(\'确认要退出?\');\">  <i class=\"fa fa-sign-out\"></i> 退出登录 </a> ");
<?
}
else
{
