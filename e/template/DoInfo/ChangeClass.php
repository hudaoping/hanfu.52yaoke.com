...
require(ECMS_PATH.'e/template/incfile/'.$public_r['add_lp1try'].'header.php');
?>
<script>
	...
	return true;
      ...
      <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" class="tableborder">
        <form action="AddInfo.php" method="get" name="changeclass" id="changeclass" onsubmit="return CheckChangeClass();">
          ...
          <tr bgcolor="#FFFFFF"> 
            <td><input type="submit" name="Submit" value="添加信息"> <font color="#0600f8">(请选择终极栏目 [ 蓝色条 ] )</font></td>
          </tr>
        </form>
      </table>
<?php
require(ECMS_PATH.'e/template/incfile/'.$public_r['add_lp1try'].'footer.php');
?>